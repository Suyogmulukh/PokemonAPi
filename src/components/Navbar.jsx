...
const Navbar = () => {
  return (
    <div className='flex justify-between lg:px-24 items-center py-3 sm:py-5 px-4 sm:px-6 bg-(--c2) sticky top-0 z-10'>
        <Link to='/' className='font-medium text-lg sm:text-xl lg:text-2xl'>Poki Info</Link>
